    ...
    <>
      <div className="relative isolate bg-white h-auto">
        <footer className="print:hidden" aria-labelledby="footerHeading">
          ...
          <div className="sm:hidden max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8sm:max-w-3xl lg:max-w-7xl  relative">
          ...
          <div className="hidden sm:block max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8  sm:max-w-3xl lg:max-w-7xl  relative">
